...
PDF-files conceived from the contributed XML-files. The renamed order contains the files received after solving encoding problems and adjusting special characters.
